...
fn test_official_ecosystem_all_pillars_exist() {
    let pillars = vec![
        ...
        ("Compiler Core Pipeline", "src/optimizer.sora"),
        ("LLVM & Native Backend", "src/codegen.sora"),
        ("Virtual Machine & Runtime", "src/vm.sora"),
        ...
        ("Package Registry Client", "src/registry.sora"),
        ("Lockfile Deterministic Engine", "src/lockfile.sora"),
        ("Language Server Protocol Daemon", "src/lsp.sora"),
        ("Formatter Engine", "src/formatter.sora"),
        ("Linter Engine", "src/linter.sora"),
        ("Interactive Debugger", "src/checker.sora"),
        ("Performance Profiler", "src/benchmark_suite.sora"),
        ("Documentation Generator", "src/docgen.sora"),
        ...
        ("VS Code Extension Source", "editors/vscode/extension.js"),
    ];
